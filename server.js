...
function getForexFactoryCalendarData() {
  ...
  return [
    ...
    },
    {
      ...
      country: '🇺🇸',
      impact: 'high',
      event: 'US Consumer Price Index (CPI MoM/YoY)',
      actual: '2.9%',
      forecast: '3.0%',
      previous: '3.1%',
      status: 'better'
    },
    {
      ...
      country: '🇺🇸',
      impact: 'high',
      event: 'US ISM Manufacturing & Service PMI',
      actual: '52.8',
      forecast: '50.5',
      previous: '49.1',
      status: 'better'
    ...
    },
    {
      ...
      country: '🇺🇸',
      impact: 'high',
      event: 'US Initial Jobless Claims & Core Retail Sales',
      actual: '225K',
      forecast: '230K',
      previous: '235K',
      status: 'better'
    ...
    },
    {
      ...
      country: '🇮🇳',
      impact: 'high',
      event: 'RBI Monetary Policy Stance & Repo Rate Decision',
      actual: '6.50%',
      forecast: '6.50%',
      previous: '6.50%',
      status: 'neutral'
    },
    {
      ...
      country: '🇺🇸',
      impact: 'high',
      event: 'Core PCE Price Index m/m (Fed Inflation Benchmark)',
      actual: '0.2%',
      forecast: '0.2%',
      previous: '0.3%',
      status: 'neutral'
